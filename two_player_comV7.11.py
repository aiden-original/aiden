...
preset = {
    ...
    "clerk":("clerk",40,40,40,40,40)
    
}
#print("the druid  *2 effectiveness of life related skills(lifesteal)" )
#print("the mage -4 magic related accurace chances" )
#print("the knight *2 effectiveness normal block amount and reflective dmg" )
#print("the hunter  convert all projectiles related skills into scalable barrage attack" )
#print("the clerk times 10 the effectiveness of healing(healing skill and buff skill) related skill " )
...
if Import == "yes" or Import == "y" or Import == "Yes":
    ...
    while ((P1fairTotal > 200)) or P2fairTotal> 200:
        ...
        while informantion == "yes" or informantion == "Yes" or informantion == "sure" or informantion == "Sure" or informantion == "yeah" or informantion == "Yeah":
            print("\n")
            print(f"the skills: \n1.lifesteal \n2.slash\n3.eternal flame\n4.heal\n(wait)")
            inType = input("what skill do you want informantion about")
        ...
        while complete == "no":
            ...
            if P1preset== "yes" or P1preset==  "y" or P1preset==  "Y" or P1preset==  "Yes":
                print(f"the presets:")
                for i in preset:
                    print(preset.get(i))
                try:
        ...
        while complete == "no":
            ...
            if P2preset== "yes" or P2preset==  "y" or P2preset==  "Y" or P2preset==  "Yes":
                print(f"the preset:")
                for i in preset:
                    print(preset.get(i))
                try:
                ...
                try:
                    P2userName= input("what is player 1 name")
                    P2fairTotal=200
...
while endgame != "yes":
    ...
    if P1statPoint >= 1 :
            print(f"you have {P1statPoint}statPoints")
            P1statUse = input("do you want to your stat point ")
    
            while c or P1statUse == "Yes"  :
                P1statMany = int(input("how many stat points do u want to use "))
                P1statChoice = input("what stat do you want increased ")
            ...
            if P1statPoint >= 10 :
                if P1presetName == "druid":
                    P1statUse = input("do you want to uses your stat point on druidUP blooldline")
                    if P1statUse == "yes" or P1statUse == "Yes" or P1statUse == "y":
                        P1statMany = int(input("how many druidUP blooldline points do u want 1 per 10 statPoints"))
                        if (P1statMany*10)<=P1statPoint:
                            P1statPoint-=(P1statMany*10)
                            P1druidUP+=P1statMany
                if P1presetName == "hunter":
                    P1statUse = input("do you want to uses your stat point on hunter blooldline")
                    if P1statUse == "yes" or P1statUse == "Yes" or P1statUse == "y":
                        P1statMany = int(input("how many hunter blooldline points do u want 1 per 10 statPoints"))
                        if (P1statMany*10)<=P1statPoint:
                            P1statPoint-=(P1statMany*10)
                if P1presetName == "knight":
                    P1statUse = input("do you want to uses your stat point on knight blooldline")
                    if P1statUse == "yes" or P1statUse == "Yes" or P1statUse == "y":
                        P1statMany = int(input("how many knight points do u want 1 per 10 statPoints"))
                        for i in range(P1statMany):
                            P1statChoice= input("do you want to upgrade reflective dmg or block efficiency")
                            try:
                ...
                if P1presetName == "clerk":
                    P1statUse = input("do you want to uses your stat point on clerk blooldline")
                    if P1statUse == "yes" or P1statUse == "Yes" or P1statUse == "y":
                        P1statMany = int(input("how many clerk points do u want 1 per 10 statPoints"))
                        for i in range(P1statMany):
                            P1statChoice= input("do you want to upgrade buff or healing efficiency")
                            try:
                                if P1statChoice == "buff" or P1statChoice == "Buff":
                                    if (P1statMany*10)<=P1statPoint:
                                        P1statPoint-=(P1statMany*10)
                                        P1buffUP+=P1statMany
                                elif P1statChoice == "healing" or P1statChoice == "Healing":
                                    if (P1statMany*10)<=P1statPoint:
                                        P1statPoint-=(P1statMany*10)
                                        P1healUP+=P1statMany
                                    else:
    ...
    if P2statPoint >= 1 :
            ...
            P2statUse = input("do you want to your stat point ")
    
            while P2statUse == "yes" or P2statUse == "Yes"  :
                P2statMany = int(input("how many stat points do u want to use "))
                P2statChoice = input("what stat do you want increased ")
                if P2statMany <= P2statPoint:
                    ...
                    if P2statChoice == "attack" or P2statChoice ==  "Attack":
                        ...
                        print("invalid")
                    print("remaining stats points:",P2statPoint)
                    P2statUse = input("use more skill points ")
                    print("\n")
            if P2statPoint >= 10 :
                if P2presetName == "druid":
                    P2statUse = input("do you want to uses your stat point on druidUP blooldline")
                    if P2statUse == "yes" or P2statUse == "Yes" or P2statUse == "y":
                        P2statMany = int(input("how many druidUP blooldline points do u want 1 per 10 statPoints"))
                        if (P2statMany*10)<=P2statPoint:
                            P2statPoint-=(P2statMany*10)
                            P2druidUP+=P2statMany
                if P1presetName == "hunter":
                    P2statUse = input("do you want to uses your stat point on hunter blooldline")
                    if P2statUse == "yes" or P2statUse == "Yes" or P2statUse == "y":
                        P2statMany = int(input("how many hunter blooldline points do u want 1 per 10 statPoints"))
                        if (P2statMany*10)<=P2statPoint:
                            P2statPoint-=(P2statMany*10)
                            P2projectileUP+=P2statMany      
                if P2presetName == "knight":
                    P2statUse = input("do you want to uses your stat point on knight blooldline")
                    if P2statUse == "yes" or P2statUse == "Yes" or P2statUse == "y":
                        P2statMany = int(input("how many knight points do u want 1 per 10 statPoints"))
                        for i in range(P2statMany):
                            P2statChoice= input("do you want to upgrade reflective dmg or block efficiency")
                            try:
                                ...
                                print("error")
                if P2presetName == "clerk":
                    P2statUse = input("do you want to uses your stat point on clerk blooldline")
                    if P2statUse == "yes" or P2statUse == "Yes" or P2statUse == "y":
                        P2statMany = int(input("how many clerk points do u want 1 per 10 statPoints"))
                        for i in range(P2statMany):
                            P2statChoice= input("do you want to upgrade buff or healing efficiency")
                            try:
                                if P2statChoice == "buff" or P2statChoice == "Buff":
                                    if (P2statMany*10)<=P2statPoint:
                                        P2statPoint-=(P2statMany*10)
                                        P2buffUP+=P2statMany
                                elif P2statChoice == "healing" or P2statChoice == "Healing":
                                    if (P2statMany*10)<=P2statPoint:
                                        P2statPoint-=(P2statMany*10)
                                        P2healUP+=P2statMany
                                    else:
        ...
        if turn == "P1" :#-------------------------------------------------------------------
            ...
            if P1newHP>0:
                ...
                if P1attackChoise == "player2" or P1attackChoise == "Player2" or P1attackChoise == P2userName:
                    if P2HP >0:
                        ...
                        TEMHP= P2HP*totalBuff
                    else:
                        print("this choice is already dead you miss your turn")
                        P1attackChoise = "null"
                elif P1attackChoise == "mob" or P1attackChoise == "monster" or P1attackChoise == lvEnemyName:
                    if lvEnemyHP >0:
                        totalBuff=1
                        if P23buff == "yes":
                    ...
                    if P1skillChoise == "lifesteal" or P1skillChoise == "Lifesteal" or P1skillChoise == "1":
                        ...
                        for i in range (P1projectile):
                            ...
                            if i != (P1projectile-1):
                                ...
                                if Tphysical_Attack <= 0:
                                    Tphysical_Attack= 1
                    elif (P1skillChoise == "buffer" or P1skillChoise == "Buffer" or P1skillChoise == str(7))and P1presetName =="clerk":
                        P1skillChoise = "buffer"
                        try:
                            P1buff = 10+P1buffUP
                            P1buffT = math.ceil(1*(P1lv/10))
                            if TEMuserName == P1userName:
                                P11buff = "yes"
                                P11buffT = P1buffT
                                print(f"{TEMuserName} has been buffed by {P1userName} with a multiplier of {P1buff} for {P1buffT} turn")
                            elif TEMuserName ==P2userName:
                                P12buff = "yes"
                                P12buffT = "yes"
                                print(f"{TEMuserName} has been buffed by {P1userName} with a multiplier of {P1buff} for {P1buffT} turn")
                            elif TEMuserName ==lvEnemyName:
                                P13buff = "yes"
                                P13buffT = "yes"
                                print(f"{TEMuserName} has been buffed by {P1userName} with a multiplier of {P1buff} for {P1buffT} turn")    
                        except:
                    ...
                    if P1attackChoise == "player2" or P1attackChoise == "Player2" or P1attackChoise == P2userName:
                        if P2presetName =="knight":
                            ...
                            if P1dead =="no" and P1newHP <=0:
                                ...
                                P2exp += 4000*P1lv
                                P2score+=400*P1lv
                        if P2block == "yes" and (P2newHP != P2HP):
                            DMG = TEMHP - P2newHP
            ...
            if P2newHP>0:
                ...
                if P2attackChoise !="null":
                    ...
                    P2perception = (P2attack+P2magic_attack)
                    TEMPerception=(TEMmagic_attack+TEMattack)
                    ...
                    if P2skillChoise == "lifesteal" or P2skillChoise == "Lifesteal" or P2skillChoise == "1":
                        ...
                        for i in range (P2projectile):
                            ...
                            if i != (P2projectile-1):
                                ...
                                if Tphysical_Attack <= 0:
                                    Tphysical_Attack= 1
                    elif (P2skillChoise == "buffer" or P2skillChoise == "Buffer" or P2skillChoise == str(7))and P2presetName =="clerk":    
                        P1skillChoise = "buffer"
                        try:
                            P2buff = 10+P2buffUP
                            P2buffT = math.ceil(1*(P2lv/10))
                            if TEMuserName == P2userName:
                                P21buff = "yes"
                                P21buffT = P2buffT
                    ...
                    if P2attackChoise == "player1" or P2attackChoise == "Player1" or P2attackChoise == P1userName:
                        if P1presetName =="knight":
                            ...
                            if P2dead =="no" and P2newHP <=0:
                                ...
                                P1exp += 4000*P2lv
                                P1score+=400*P2lv
                        if P1block == "yes" and (P2newHP != P2HP):
                            DMG = TEMHP - P1newHP
            ...
            if P13buff == "yes":
                ...
                if P13buffT==0:
                    P13buff == "no"
        print(f"{P1userName}:hp is{P1HP}\n{P2userName}:hp is{P2HP}\n{lvEnemyName}:hp is{lvEnemyHP}")    
    #    
    if P1newHP <= 0:
...
if saveP == "yes":
    ...
    if P1buffUP > 0:
        P1statPoint+= 10*P1buffUP
    if P2buffUP > 0:
        P2statPoint+= 10*P2buffUP
        
    if P1healUP > 0:
        P1statPoint+= 10*P1healUP
    if P2healUP > 0:
        P2statPoint+= 10*P2healUP
        
    saveName = input("what is the file name")
    saveName = str(saveName)+".txt"
    file.open(saveName,"w")
    userDataBase = P1userName,P1attack,P1defence,P1magic_attack,P1magic_defence,P2HP,P1lv,P1exp,P1godhood,P1score,"$",P2userName,P2attack,P2defence,P2magic_attack,P2magic_defence,P2HP,P2lv,P2exp,P2godhood,P2score
